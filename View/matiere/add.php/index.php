...
<body>
    ...
    <div class="container mt-4">
      <h1 class="text-center">Ajouter MATIERE</h1>
      <br>
      <br>
      <br>
      <section id="cover">
              ...
              <div class="container">
                  <div class="row text-white">
                      <div class="col-xl-5 col-lg-6 col-md-8 col-sm-10 mx-auto text-center form p-4">
                          <div class="px-2">
                              <form action="http://localhost/gestionEmplois/matiere/ajouter" class="justify-content-center" method="POST">
                                  <div class="form-group">
                                      <input type="text" class="form-control" id="libelleMatiere" placeholder="Nom du Matiere" name="libelleMatiere">
                                  </div>
                                  <br>
