...
<body>
    ...
    <div class="container mt-4">
      <h1 class="text-center">Modifier Groupe</h1>
      <br>
      <br>
      <br>
      <section id="cover">
              ...
              <div class="container">
                  <div class="row text-white">
                      <div class="col-xl-5 col-lg-6 col-md-8 col-sm-10 mx-auto text-center form p-4">
                          <div class="px-2">
                              <form action="http://localhost/gestionEmplois/groupe/edit" class="justify-content-center" method="POST">
                                  <input type="hidden" class="form-control" id="idGroupe" name="idGroupe" value="<?=$result['idGroupe']?>">
                                  <div class="form-group">
                                      <input type="text" class="form-control" id="libelleGroupe" name="libelleGroupe" value="<?=$result['libelleGroupe']?>">
                                  </div>
                                  <div class="form-group">
                                      <input type="text" class="form-control" name="effectif" value="<?=$result['effectif']?>">
                                  </div>
                                  <br>
